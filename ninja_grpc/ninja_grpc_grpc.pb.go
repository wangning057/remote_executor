...
func (c *executorClient) Execute(ctx context.Context, in *Command, opts ...grpc.CallOption) (*ExecuteResult, error) {
	out := new(ExecuteResult)
	err := c.cc.Invoke(ctx, "/ninja_grpc.Executor/Execute", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedExecutorServer) Execute(context.Context, *Command) (*ExecuteResult, error) {
...
func _Executor_Execute_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ninja_grpc.Executor/Execute",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecutorServer).Execute(ctx, req.(*Command))
	}
...
var Executor_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "ninja_grpc.Executor",
	...
	Metadata: "ninja_grpc/ninja_grpc.proto",
}
